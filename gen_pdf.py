...
pdf.cell(0, 10, 'Pease Proxy Client - Comprehensive Audit & Perfection Report', 0, 1, 'C')
pdf.ln(10)
...
pdf.bullet_point('Privacy: Policy deployed at https://www.peaairport.org/privacy/.')
